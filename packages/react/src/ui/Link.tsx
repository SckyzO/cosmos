...
const VARIANT_CLASS: Record<LinkVariant, string> = {
  ...
  opacity:
    'text-gray-700 opacity-70 hover:opacity-100 dark:text-gray-200',
  'opacity-hover':
    'text-gray-700 transition-opacity hover:opacity-70 dark:text-gray-200',
  subtle:
...
export const Link = forwardRef<HTMLAnchorElement, LinkProps>(function Link(
  ...
  return (
    <a
      ...
      rel={finalRel}
      className={clsx(
        'inline-flex items-center gap-1 text-sm font-medium transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-500/40 focus-visible:rounded',
